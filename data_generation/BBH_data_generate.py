...
# Veriyi kaydet
df.to_csv("/Users/aycayk/Desktop/myz_project/myz/data/1000_example/BBH_1000_4K.csv", index=False)

print("Veri CSV formatında kaydedildi: BBH_dataset.csv")
