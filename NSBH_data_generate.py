...
for i in range(num_samples):
    ...
    spin_1z = np.random.uniform(-0.5, 0.5)  # Rastgele spin
...
# Tüm sinyalleri oluşturduktan sonra CSV formatında kaydetme
import pandas as pd
...
# Veriyi kaydet
df.to_csv("/Users/aycayk/Desktop/myz_project/myz/data/1000_example/NSBH_1000_4K.csv", index=False)

print("Veri CSV formatında kaydedildi: NSBH_dataset.csv")
